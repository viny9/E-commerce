...
export class DeleteAccountComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private firestore: AngularFirestore, private auth: AngularFireAuth, private dialog: MatDialogRef<SignInComponent>, private userService: UserService, private errorsService: ErrorsService) { }

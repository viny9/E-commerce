...
export class StripeService {
  ...
  constructor(private http: HttpClient, private firebase: AngularFirestore, private errorsService: ErrorsService) { }

  // Pagamentos
  productPayment(paymentConfig: Product) {
    return this.http.post(`${this.baseUrl}/checkout`, paymentConfig)
      .pipe(
  ...
  cartPayment(paymentConfig: Product) {
    return this.http.post(`${this.baseUrl}/checkout-cart`, paymentConfig)
      .pipe(
        catchError((e: Error) => this.errorsService.handleError(e))
      )
      .subscribe((res: any) => {
